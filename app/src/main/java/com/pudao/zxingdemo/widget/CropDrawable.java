...
public class CropDrawable extends Drawable {
    ...
    private int mCropWidth = 600, mCropHeight = 600;
    ...
    public void draw(Canvas canvas) {
        ...
        Log.e("tag", "CropDrawable  mCropWidth="+mCropWidth); //600
        mTop = (height - mCropHeight) / 2;
        Log.e("tag", "CropDrawable  mLeft="+mCropHeight); //600
        mRight = (width + mCropWidth) / 2;
        mBottom = (height + mCropHeight) / 2;
        Rect rect = new Rect(mLeft, mTop, mRight, mBottom);
        Log.e("tag", "CropDrawable:"+rect.toString());
        //Crop:Rect(240, 660 - 840, 1260)
